...
const Message = ({ type, url, adminInfo }) => {
  const map = {
    'Forgot Password': {
      from: `${adminInfo.base.adminName} <${adminInfo.website.email}>`,
      to: adminInfo.website.email,
      subject: `重新设置密码`,
      html: `
          <center>
                          ...
                          <td>
                              <div style="padding: 30px;color: #303030;border-radius: 8px;box-shadow: 0 0 10px #eee;padding: 1.5rem;">
                                  <p style="text-indent: 2em;color:#303030;font-size: 0.9rem;line-height: 24px;">
                                      这么简单就忘记密码？<br>
                                      <a href="${url}">给你一次机会，点我重新设置密码(24小时内有效)</a>
                                  </p>
                                  <p style="text-align: right;margin-top: 40px;font-size:0.9rem">—— ${adminInfo.base.adminName}</p>
...
// const options = [
//   {
//     from: `${info.base.adminName} <${info.administrator.email}>`,
//     to: data.email,
...
//                                       <p style="text-align: right;margin-top: 10px;font-size:0.9rem">—— ${info.base.adminName}</p>
...
//                                       <p style="text-align: right;margin-top: 40px;font-size:0.9rem">—— ${info.base.adminName}</p>
//                                       <div style="background: #eff5fb;border-left: 4px solid #c2e1ff;padding: 14px;margin-top: 30px;border-radius: 9px;font-size: 0.85rem;color: #7d7f7f;line-height: 24px;">如果我们没有机会见面，那我在这儿提前预祝你早安、午安以及晚安～～<br>愿所有的美好如约而至，愿所有的黑暗都能看到希望，我们微笑前行～～<br>人生没有完美，也许有些遗憾才美～～永远相信美好的事情即将发生～～</div>
//                                   </div>
//                               </td>
//                           </tr>
...
//     from: `${info.base.adminName} <${info.administrator.email}>`,
//     to: data.email,
//     subject: data.title + ' | ' + info.base.adminName,
//     html: `
//               <center>
//                   <table style="max-width:800px;letter-spacing: 0.2px;">
//                       <tbody>
...
//                               <td>
//                                   <div style="padding: 30px;color: #303030;border-radius: 8px;box-shadow: 0 0 10px #eee;padding: 1.5rem;">
//                                       <h2 style="font-size: 16px;font-weight: 400;font-size:font-size: 1rem;">hi，${data.adminName}，你今天笑了么～</h2>
